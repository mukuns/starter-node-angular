...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf angular-temp && mkdir angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r angular-temp/* starter-node-angular/ && rm -rf angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `angulat-temp` folder.');
